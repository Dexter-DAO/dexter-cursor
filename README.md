...
`npx @dexterai/opendexter@1.23.2 connect` creates a read-only account link for
...
```bash
npx @dexterai/opendexter@1.23.2 settings
npx @dexterai/opendexter@1.23.2 settings --max-amount 2.50 --daily-budget 20
```

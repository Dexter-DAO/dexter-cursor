...
This guide belongs to `@dexterai/opendexter@1.24.0-rc.2`. Its executable examples
...
```bash
npx @dexterai/opendexter@1.24.0-rc.2 doctor --client codex
```
...
```bash
npx @dexterai/opendexter@1.24.0-rc.2 wallet --legacy-recovery
```
